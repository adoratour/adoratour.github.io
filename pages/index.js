...
import SectionBlogGrid from 'components/SectionBlogGrid/SectionBlogGrid'
...
export default function HomePage({
  ...
  return (
    <>
      <Head>
        <title>TripFinder. | A Greatest Travel Booking Site</title>
      </Head>
      <SearchArea />
      ...
      <Container fluid={true}>
        ...
        />
        <SectionTitle
          title={<Heading content="Best Rated: Luxary tours" />}
          link={
            <Link href={LISTING_POSTS_PAGE}>
              <a>Show all</a>
            </Link>
        ...
        />
        <SectionTitle
          title={<Heading content="Most Viewed: Exp Blog" />}
          link={
            <Link href={LISTING_POSTS_PAGE}>
              <a>Show all</a>
            </Link>
